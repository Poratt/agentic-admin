...
- **Committed + pushed + MERGED to `main`** (ff `150c17c..7d98ea9`, 2026-09-18): `741d55f` chore(tests) + `c44f737` feat(llm-providers) + `919cea4` docs(session) + `7d98ea9` docs(feature, plan → `done/`). New clean branch opened: `feat/static-tool-tier-filtering`.
